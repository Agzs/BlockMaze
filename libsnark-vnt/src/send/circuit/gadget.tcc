...
public:
    ...
    // cmtA = sha256(value_old, sn_old, r_old)
    ...
    std::shared_ptr<sha256_three_block_gadget<FieldT>> commit_to_inputs; // note_commitment
    ...
    send_gadget(
        ...
        commit_to_inputs.reset(new sha256_three_block_gadget<FieldT>( 
            pb,
            ZERO,
    ...
    void generate_r1cs_witness(
        ...
        lessCMP->generate_r1cs_witness(note_old, notes);
