...
boost::optional<r1cs_se_ppzksnark_proof<ppzksnark_ppT>> generate_mint_proof(r1cs_se_ppzksnark_proving_key<ppzksnark_ppT> proving_key,
                                                                    const Note& note_old,
                                                                    const Note& note,
                                                                    uint256 cmtA_old,
                                                                    uint256 cmtA,
                        ...
                        )
{
    ...
    auto proof = generate_mint_proof<default_r1cs_se_ppzksnark_pp>(keypair.pk, 
                                                            note_old,
                                                            note,
                                                            cmtA_old,
                                                            cmtA,
...
int main () {
    ...
    //test_r1cs_se_ppzksnark<dsefault_r1cs_se_ppzksnark_pp>(1000, 100);
    ...
    test_mint_gadget_with_instance<default_r1cs_se_ppzksnark_pp>(value, value_old, value_s, keypair);
