 ...
 ***********************************************************
 * sha256_CMTA_gadget, addition_constraint, 
 * sha256_CMTS_gadget, merkle_gadget
 **************************************************************
...
public:
    ...
    // cmtS = sha256(value_s, pk, r_s, sn_A_old, padding)
    ...
    void generate_r1cs_constraints() { 
        ...
        sn_s->generate_r1cs_constraints();
        prf_to_inputs_sn_s->generate_r1cs_constraints();
    ...
    void generate_r1cs_witness(
        ...
        prf_to_inputs_sn_s->generate_r1cs_witness();

        sn_s->bits.fill_with_bits(
            this->pb,
            uint256_to_bool_vector(sn_s_data)
        );
