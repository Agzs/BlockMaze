...
r1cs_se_ppzksnark_proof<ppzksnark_ppT> generate_deposit_proof(r1cs_se_ppzksnark_proving_key<ppzksnark_ppT> proving_key,
                                                           const NoteS &note_s,
                                                           const Note &note_old,
                                                           const Note &note,
                                                           uint256 cmtS,
                      ...
                      char *sk_string)
{
    ...
    libsnark::r1cs_se_ppzksnark_proof<libff::alt_bn128_pp> proof = generate_deposit_proof<alt_bn128_pp>(keypair.pk,
                                                                                                     note_s,
                                                                                                     note_old,
                                                                                                     note,
                                                                                                     cmtS,
