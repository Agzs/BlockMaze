...
r1cs_se_ppzksnark_proof<ppzksnark_ppT> generate_redeem_proof(r1cs_se_ppzksnark_proving_key<ppzksnark_ppT> proving_key,
                                                          Note &note_old,
                                                          Note &note,
                                                          uint256 cmtA_old,
                                                          uint256 cmtA,
                     ...
                     )
{
    ...
    libsnark::r1cs_se_ppzksnark_proof<libff::alt_bn128_pp> proof = generate_redeem_proof<alt_bn128_pp>(keypair.pk, note_old, note, cmtA_old, cmtA, value_s, sk);
