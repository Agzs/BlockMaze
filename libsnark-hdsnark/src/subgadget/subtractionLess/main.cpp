...
void PrintProof(r1cs_ppzksnark_proof<ppzksnark_ppT> proof)
{
    printf("================== Print proof ==================================\n");
    //printf("proof is %x\n", *proof);
    std::cout << "subtractionLess proof:\n";
                        ...
                        )
{
    ...
    // verify proof
    if (!proof) {
        printf("generate subtractionLess proof fail!!!\n");
        return false;
    } else {
        PrintProof(*proof);
        ...
        if (!result){
            cout << "Verifying subtractionLess proof unsuccessfully!!!" << endl;
        } else {
            cout << "Verifying subtractionLess proof successfully!!!" << endl;
        }
