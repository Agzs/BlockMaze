...
int main()
{
...

    {
        ...
        tuple_data_bv = int_list_to_bits({
            ...
            80, 75, 115, 178, 85, 17, 148, 178, 17, 126, 39, 9, 34, 14, 66, 65, 203, 6, 191, 16, 141, 210, 73, 136, 65, 136, 152, 60, 117, 24, 101, 18, 
            80, 75, 115, 178, 85, 17, 148, 178, 17, 126, 39, 9, 34, 14, 66, 65, 203, 6, 191, 16, 141, 210, 73, 136, 65, 136, 152, 60, 117, 24, 101, 18, 
            80, 75, 115, 178, 85, 17, 148, 178, 17, 126, 39, 9, 34, 14, 66, 65, 203, 6, 191, 16, 141, 210, 73, 136, 65, 136, 152, 60, 117, 24, 101, 18}, 8);
        
        hash_test_bv = int_list_to_bits({190, 120, 255, 212, 127, 96, 31, 93, 67, 149, 152, 141, 198, 30, 121, 200, 160, 77, 216, 203, 85, 2, 143, 105, 60, 10, 119, 96, 113, 148, 58, 240}, 8);
    }
    ...
    if (!proof) {
        ...
        bool result = verify_proof(keypair.vk, *proof, hash_test_bv);
