...
template class NoteEncryption<VNT_NOTEPLAINTEXT_LEADING + VNT_V_SIZE + VNT_RHO_SIZE + VNT_R_SIZE + VNT_MEMO_SIZE>;
template class NoteDecryption<VNT_NOTEPLAINTEXT_LEADING + VNT_V_SIZE + VNT_RHO_SIZE + VNT_R_SIZE + VNT_MEMO_SIZE>;
