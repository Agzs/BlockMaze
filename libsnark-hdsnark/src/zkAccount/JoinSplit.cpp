...
#include "zkAccount/circuit/gadget.tcc"
    ...
    std::string prove(
        ...
        // plaintexts to the recipients of the value.
        {
            ...
            for (size_t i = 0; i < NumOutputs; i++) {
                ...
                boost::array<unsigned char, VNT_MEMO_SIZE> memo = {{0xF6}};
...
template class JoinSplit<VNT_NUM_JS_INPUTS,
                         VNT_NUM_JS_OUTPUTS>;
