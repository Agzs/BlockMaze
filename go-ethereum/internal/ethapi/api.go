...
func (s *PublicTransactionPoolAPI) SendMintTransaction(ctx context.Context, args SendTxArgs) (common.Hash, error) {
	...
	if err == nil {
		...
		SNS := zktx.SequenceS{*zktx.SequenceNumber, *zktx.SequenceNumberAfter, zktx.SNS, zktx.RandomReceiverPK,zktx.Mint}
...
func (s *PublicTransactionPoolAPI) GetPubKeyRLP(ctx context.Context, address common.Address, passwd string) (string, error) {
	...
	// fmt.Println(common.ToHex(pp))
	// return hexutil.Bytes(string(common.ToHex(pp))), err
...
func (s *PublicTransactionPoolAPI) SendSendTransaction(ctx context.Context, args SendTxArgs) (common.Hash, error) { //tbd
	...
	if err == nil {
		...
		SNS := zktx.SequenceS{*zktx.SequenceNumber, *zktx.SequenceNumberAfter, zktx.SNS, zktx.RandomReceiverPK, zktx.Send}
		SNSBytes, err := rlp.EncodeToBytes(SNS)
		if err != nil {
			fmt.Println("encode sns error")
			return common.Hash{}, nil
...
func (s *PublicTransactionPoolAPI) SendUpdateTransaction(ctx context.Context, args SendTxArgs) (common.Hash, error) {
	if zktx.Stage != zktx.Send {
		fmt.Println("updateTx must after sendTx, but last tx is not a sendTx")
		return common.Hash{}, nil
	}
	if zktx.SNfile == nil {
		fmt.Println("SNfile does not exist")
	...
	newRandom := zktx.NewRandomHash()                                  //A 新 r
	newValue := SNa.Value - SNs.Value                                  //update后 A新value
...
loop: //得到 cmts
	...
	if err == nil {
		...
		SNS := zktx.SequenceS{*zktx.SequenceNumber, *zktx.SequenceNumberAfter, zktx.SNS, zktx.RandomReceiverPK, zktx.Update}
		SNSBytes, err := rlp.EncodeToBytes(SNS)
		if err != nil {
			fmt.Println("encode sns error")
			return common.Hash{}, nil
...
loop:
	...
	if err == nil {
		...
		SNS := zktx.SequenceS{*zktx.SequenceNumber, *zktx.SequenceNumberAfter, zktx.SNS, zktx.RandomReceiverPK, zktx.Deposit}
		SNSBytes, err := rlp.EncodeToBytes(SNS)
		if err != nil {
			fmt.Println("encode sns error")
			return common.Hash{}, nil
...
func (s *PublicTransactionPoolAPI) SendRedeemTransaction(ctx context.Context, args SendTxArgs) (common.Hash, error) {
	...
	if err == nil {
		...
		SNS := zktx.SequenceS{*zktx.SequenceNumber, *zktx.SequenceNumberAfter, zktx.SNS, zktx.RandomReceiverPK, zktx.Redeem}
